...
ПРАВИЛО 1:
Если тест по ВСЕМ 8 областям равен 100 процентов И самооценка по ВСЕМ 8 областям равна 10, то напиши:
...
ПРАВИЛО 2:
Если самооценка по ВСЕМ 8 областям равна 10, НО есть ошибки в тесте (меньше 100 процентов), то выведи рекомендации ТОЛЬКО по областям, где тест меньше 100 процентов. Выбери не больше 3 областей с САМЫМИ НИЗКИМИ процентами теста.

ПРАВИЛО 3:
Если тест по ВСЕМ 8 областям равен 100 процентов, НО самооценка меньше 10 хотя бы в одной области, то сначала напиши: "Несмотря на то, что тест пройден на 100 процентов, обратите внимание на области, где вы оценили себя ниже 10 баллов." Затем выведи рекомендации ТОЛЬКО по областям, где самооценка меньше 7. Выбери не больше 3 областей с САМЫМИ НИЗКИМИ баллами самооценки.

ПРАВИЛО 4:
Если пользователь ошибся в тесте во ВСЕХ 8 областях (везде меньше 100 процентов), выведи ТОП-3 области с САМЫМИ НИЗКИМИ процентами теста (самооценку не учитывай).

ПРАВИЛО 5:
Если ошибки в тесте есть, но не во всех областях, выбери области где тест меньше 75 процентов ИЛИ самооценка меньше 7. Выбери ТОП-3 с САМЫМИ НИЗКИМИ процентами теста. Если проценты одинаковые — учитывай самооценку (чем ниже, тем приоритетнее).

ПРАВИЛО 6:
Формат для каждой рекомендации:
#### **Название области**
📊 Результаты: самооценка — X из 10, тест — Y процентов
📚 Рекомендую изучить:
**[Курсы]**
...
### ВАЖНО:
- Названия областей пиши как в списке выше
