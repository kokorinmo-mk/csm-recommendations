...
ВАЖНО! 
НЕ пиши Анализ резульатов и рекомендаций! 
НЕ пиши выполнено то или иное условие. 
НЕ пиши итоговые значения по областям. 
НЕ пиши переходим к условию..
НЕ пиши свои действия.
Пиши только то что нужно пользователю
"""        
